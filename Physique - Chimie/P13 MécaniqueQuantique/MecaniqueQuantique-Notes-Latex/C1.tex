...
\begin{Prop}{Balles (particule)}{}
                \begin{figure}[H] %h:当前位置, t:顶部, b:底部, p:浮动页
                    \centering
                    \includegraphics[width=0.8\textwidth]{./assets/Interférence de Young - Balles.png}
...
\begin{Prop}{Onde d'eau (onde)}{}
                \begin{figure}[H] %h:当前位置, t:顶部, b:底部, p:浮动页
                    \centering
                    \includegraphics[width=0.8\textwidth]{./assets/Interférence de Young - Onde d'eau.png}
...
\begin{Prop}{Électrons (objet microscopique)}{}
                \begin{figure}[H] %h:当前位置, t:顶部, b:底部, p:浮动页
                    \centering
                    \includegraphics[width=0.8\textwidth]{./assets/Interférence de Young - Électrons.png}
